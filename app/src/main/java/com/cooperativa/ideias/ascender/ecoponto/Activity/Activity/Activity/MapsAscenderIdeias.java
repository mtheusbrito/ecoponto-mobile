...
public class MapsAscenderIdeias extends SupportMapFragment implements OnMapReadyCallback,
 ...
 if (!isLocationEnabled(getContext())) {
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.addMarker(new MarkerOptions().position(new LatLng(-21.202056,-41.9095845))
                .title("Nos encontre").snippet(" Ascender Ideias Cooperativa"));
